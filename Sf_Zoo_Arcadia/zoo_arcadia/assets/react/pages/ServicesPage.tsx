                  ...
                  <div className="row justify-content-center mx-0">
                    {service.sousServices.map((sousService, sousIndex) => {
                      ...
                      return (
                        <div
                          key={sousService.nom}
                          className={`sous-service col-11 col-md-3 d-flex flex-column justify-content-center align-items-center px-lg-4 mx-sm-2 p-0 h-sm-100 ${sousIndex === 0 ? "first-sous-service" : sousIndex === service.sousServices.length - 1 ? "last-sous-service" : ""}`}
                        >

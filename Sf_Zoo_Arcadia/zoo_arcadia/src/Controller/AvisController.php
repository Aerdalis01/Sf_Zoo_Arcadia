...
class AvisController extends AbstractController
{
    ...
    public function approveReview($id, AvisRepository $avisRepository, EntityManagerInterface $em, Request $request): JsonResponse
    {
    ...
    public function deleteAvis(int $id, AvisRepository $avisRepository, EntityManagerInterface $entityManager, Request $request): JsonResponse
    {
        $this->tokenValidator->validateTokenAndRoles(
            $request->headers->get('Authorization'),
            ['ROLE_ADMIN', 'ROLE_EMPLOYE']

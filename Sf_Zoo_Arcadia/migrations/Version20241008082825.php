 ...
 */
final class Version20241008082825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service ADD image_id INT DEFAULT NULL, DROP image, DROP sous_service');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service ADD image VARCHAR(255) DEFAULT NULL, ADD sous_service VARCHAR(255) DEFAULT NULL, DROP image_id');
    }
}
